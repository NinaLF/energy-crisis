...
plot_model(model.H4a.error.both,
                    ...
                    colors=c( "#15A000", "#0070C0")) + xlim(-2,2) +
...
# controlling for cc concern
model.H4.wave2.error.c <- glmer(choice ~ price.level + energy.level*mean.error_scaled +
                                  country  + concern.scaled +
                                  gender + age + income + education  +
                                  (1| m),
                                data=data.everything.w2_clean, family="binomial")
tab_model(model.H4.wave2.error.c)
...
model.H4.wave2.concern <- glmer(choice ~ price.level + energy.level*concern.scaled +
                                ...
                                data=data.everything.w2_clean, family="binomial")
tab_model(model.H4.wave2.concern)
plot_model(model.H4.wave2.concern, type="pred", terms=c("concern.scaled", "energy.level"),
           colors=c("#0070C0", "#15A000")) +
